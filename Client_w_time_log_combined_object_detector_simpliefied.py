    ...
    if operating_system == "windows" or operating_system == "Windows":
        ...
        for line in lines: 
            ...
            if "Signal level" in line: 
                RSSI_val = line.split('=')[1].split(' ')[0].strip()
    else:
...
def main():
    #server_uri = "kubernetesobject-uni-stuttgart-5g-tes.frankfurt-main-tdg.eu.app.edge.telekom.com" #
    #server_uri = "messung-uni-stuttgart-5g-tes.frankfurt-main-tdg.eu.app.edge.telekom.com"
    #host = socket.gethostbyname(server_uri)
    host = '192.168.2.204' 
    #host = '2001:7c0:2320:1:f816:3eff:fe34:e745'
    #host = '10.8.0.1' 
    #host = '172.17.0.2'
    #port = 1194 
    port = 51821 
    ...
    while True: # infinite loop for data transmission
        last_time = time.perf_counter_ns()  # set init time for timing
        image_size = 0
        if not connected:
